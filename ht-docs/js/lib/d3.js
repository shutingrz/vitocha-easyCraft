!function() {
  ...
  function d3_selection_attr(name, value) {
    ...
    //    console.log("value.apply is " + value.apply(this, arguments));
//    console.log("arguments is " + arguments);
//    console.log(arguments.toSource());
//    console.log(arguments["0"]);
       var flag = false;
/*        if(arguments["0"]["x"] != undefined){
            console.log(arguments["0"]["x"] + "," + arguments["0"]["px"] + "," + arguments["0"]["y"] + "," + arguments["0"]["py"]);
        if((isNaN(arguments["0"]["x"]))){
        //    flag = true;
            arguments["0"]["x"] = Math.random() * 1000;
            arguments["0"]["px"] = arguments["0"]["x"]+ 00.0 ;
            arguments["0"]["y"] =  Math.random() * 1000;
            arguments["0"]["py"] = arguments["0"]["y"]+00.0 ;

        }}*/
      var x = value.apply(this, arguments);
      if (x == null ){this.removeAttribute(name);}
      else if(flag == true){
          this.setAttribute(name, translate(300,300));
      }
      else{
    //      console.log(x);
